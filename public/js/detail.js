...
xhr.onload = function() {                       // When readystate changes
  ...
  //if(xhr.status === 200) {                      // If server status was ok
    ...
    for (var i = 0; i < responseObject.staff.length; i++) { // Loop through object
      ...
      newContent += '<div class="middle" id="middle" style="display:none"><div class="weui-slider-box" id="slider1"><div class="weui-slider"><div id="sliderInner" class="weui-slider__inner"><div id="sliderTrack" style="width: '+responseObject.staff[i].score+'%;" class="weui-slider__track"></div>'
